...
begin
  ...
  //Feld oben mitte und unten (3x3, 2x3, 3x3)
  for x := 12 to 14 do
  begin
    //Feld 1
    Spielfeld[x,2] := 1;
...
{procedure TOpPcm_main.DrawGrid;
var
  x,y: Integer;
begin
  for x := 0 to 25 do
...
procedure TOpPcm_main.DrawCells;
var
  x,y: Integer;
begin
  // Spielfeld zeichnen
...
//Mit Maus malen
{procedure TOpPcm_main.ImgFeldMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
  FeldX, FeldY : Integer;
begin
...
procedure TOpPcm_main.BtnResetClick(Sender: TObject);
begin
  Reset;
end;
